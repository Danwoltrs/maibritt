...
export default function Header() {
  ...
  const quickActions = [
    ...
    { key: 'upcoming-exhibition' as QuickAction, label: 'Upcoming Exhibition', icon: Calendar },
  ]
  ...
  return (
    <>
                  ...
                  <ContextMenu>
                    <ContextMenuTrigger asChild>
                      <Link
                        ...
                        title="Go to Artist Portal — right-click for quick actions"
                      >
                    ...
                    <ContextMenuContent className="w-56">
                      {quickActions.map((action) => (
                        <ContextMenuItem
                          ...
                          onSelect={() => setQuickAction(action.key)}
                        >
      ...
      <QuickActionDialogs activeAction={quickAction} onClose={() => setQuickAction(null)} />
    </>
  )
}
